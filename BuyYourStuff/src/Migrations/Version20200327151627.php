 ...
 */
final class Version20200327151627 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD categorie_id INT NOT NULL, ADD namec VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product DROP categorie_id, DROP namec');
    }
}
